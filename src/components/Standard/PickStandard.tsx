...
export default function PickStandard({onSelect}: Props) {
    ...
    return (
        <>
            <img src="/images/bg-triangle.svg" className="z-[10] absolute w-[50vw] lg:w-[400px] mt-10 sm:mt-15 md:mt-30 left-1/2 -translate-x-[50%] top-1/2 -translate-y-[50%]"/>
            <section id="standard-game-play" className="absolute left-1/2 -translate-x-[50%] z-[20] top-1/2 -translate-y-[50%] mt-10 md:mt-25">
