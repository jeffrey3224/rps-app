...
export default function BonusRules({onSelect, showRules}: Props) {
    ...
    return (
        showRules && 
            (   <div className="z-100 absolute top-0 left-0 w-[100vw] h-[100vh] flex justify-center items-center bg-black/50">
                    <div className="bg-white p-10 rounded-2xl flex flex-col justify-end relative">
                        ...
                        <img src="/images/image-rules-bonus.svg" className="w-[60vw] md:w-[25vw] min-w-[200px] max-w-[400px]" />
